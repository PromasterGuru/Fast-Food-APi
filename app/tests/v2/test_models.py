...
class TestModels(unittest.TestCase):
    ...
    def test_push1_one_menu_item(self):
        ...
        meal_price = 45.00
        self.orders.set_menu(meal_name, meal_desc, meal_price)
    ...
    def test_push1_one_user_record(self):
        ...
        self.orders.set_users(username, password)
        self.assertNotEqual(len(self.orders.get_users()), 0)

    def test_push1_one_food_order_record_with_wrong_user_credntials(self):
        """Test when one order record is added"""
        order_id = 142
